                    ...
                    <div className="col-xs-12 col-md-4">
                        <div className="subCard">
                            ...
                            <div className="subCard__middle">
                                <p>We share monthly activity sheets that mention each and everything we do for your brand. 
                                    This keeps you in check about what's being done on your website so that you can
